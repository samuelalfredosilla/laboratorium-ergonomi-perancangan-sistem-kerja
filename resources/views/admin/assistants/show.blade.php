...
<div
    x-data="{
        ...
        form: {
            name: @js($assistant->name),
            nim: @js($assistant->nim ?? ''),
            division: @js($assistant->division ?? ''),
            period: @js($assistant->period ?? '2025/2026'),
            email: @js($assistant->email ?? ''),
...
>
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" @click="panelOpen = true" class="inline-flex items-center justify-center gap-2 rounded-lg bg-maroon-600 px-4 py-2.5 text-sm font-semibold text-white shadow-soft hover:bg-maroon-700 transition-colors cursor-pointer">
    ...
    <div class="grid grid-cols-1 items-start gap-6 lg:grid-cols-3">
        <!-- Profile Card (Sticky Aman di Bawah Navbar) -->
        <div class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-soft lg:col-span-1 lg:sticky lg:top-24">
        ...
        <!-- Detail Information & Scrollable Logs Card -->
        <div class="space-y-6 lg:col-span-2">
            ...
            <!-- Riwayat Perubahan Data Card (Scrollable) -->
        ...
        <div class="fixed inset-y-0 right-0 top-0 h-full flex max-w-full pl-10">
            <div x-show="panelOpen" x-transition:enter="transform transition ease-in-out duration-300" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transform transition ease-in-out duration-200" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full"
                ...
                <div class="flex items-center justify-between border-b border-slate-200 px-6 py-4 bg-white">
                    ...
                    <button type="button" @click="panelOpen = false" class="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600">
                ...
                <div class="flex items-center justify-end gap-3 border-t border-slate-200 px-6 py-4 bg-white">
                    <button type="button" @click="panelOpen = false" class="rounded-xl border border-slate-200 px-4 py-2.5 text-xs font-semibold text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer">Batal</button>
